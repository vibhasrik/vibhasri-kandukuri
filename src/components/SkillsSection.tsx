...
const SkillsSection = () => {
  return (
    <section id="skills" className="section-margin section-padding relative">
      ...
      <div
        className="gradient-blob w-72 h-72 bg-coral/10 bottom-20 -right-20 animate-blob"
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            A comprehensive toolkit spanning multiple domains of computer
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {Object.entries(skillsData).map(([category, skills], index) => (
            <Card
              key={index}
              className="glass-card hover:shadow-glow transition-all duration-300 hover:scale-[1.01]"
            >
      ...
      <div className="wave-divider">
        <svg viewBox="0 0 1200 120" preserveAspectRatio="none">
          <path
            d="M1200 120L0 120 892.25 114.72 1200 0z"
            fill="rgba(135, 110, 131, 0.05)"
          ></path>
        </svg>
      </div>
    </section>
